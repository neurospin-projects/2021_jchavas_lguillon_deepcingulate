...
def gridsearch_bVAE_sub1(trainloader, valloader):
    ...
    for kl, n in list(itertools.product(config["kl"], config["n"])):
        ...
        root_dir = f"/neurospin/dico/lguillon/midl_22/new_design/half2/n_{n}_kl_{kl}/"
...
def main():
    ...
    torch.manual_seed(0)
    root_dir = f"/neurospin/dico/lguillon/midl_22/new_design/half2/"
    subset1 = create_subset(idx_subset=2)
